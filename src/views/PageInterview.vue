...
<template>
  ...
  <div class="content-interview" v-else-if="interview?.id && !isLoading">
    <app-card>
      <template #title>{{ interview.company }} Interview</template>
      <template #content>
        ...
        <div class="flex flex-column gap-2">
          <label for="contactTelegram">HR Telegram username</label>
          <app-input-text
            class="input mb-3"
            id="contactTelegram"
        ...
        <div class="flex flex-column gap-2">
          <label for="contactWhatsApp">HR Whatsapp username</label>
          <app-input-text
            class="input mb-3"
            id="contactWhatsApp"
        ...
        <template v-if="interview.stages">
          <div v-for="(stage, index) in interview.stages" :key="index" class="interview-stage">
            ...
            <div class="flex flex-column gap-2">
              <label :for="`stage-date-${index}`">Stage Date</label>
              <app-calendar
                class="input mb-3"
                :id="`stage-date-${index}`"
                dateFormat="dd.mm.yy"
